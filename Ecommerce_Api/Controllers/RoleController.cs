...
namespace Ecommerce_Api.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        {
            SuccessResponse response = await _roleservice.CreateRoleAync(request);
            return Ok(response);
        }
        ...
        {
            AddUserToRoleResponse response = await _roleservice.AddUserToRole(request);
            return Ok(response);
        }
        ...
        {
            SuccessResponse response = await _roleservice.RemoveUserFromRole(request);
            return Ok(response);
        }
        ...
        {
            SuccessResponse response = await _roleservice.EditRole(id, Name);
            return Ok(response);
        }
        ...
        {
            SuccessResponse response = await _roleservice.DeleteRole(Name);
            return Ok(response);
        }
        ...
        {
            IEnumerable<RoleResponse> response = await _roleservice.GetAllRoles();
            return Ok(response);
        }
        ...
        {
            IEnumerable<string> response = await _roleservice.GetUserRoles(Username);
            return Ok(response);
        }
